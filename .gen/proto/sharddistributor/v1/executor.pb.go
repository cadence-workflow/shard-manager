...
const (
	...
	ExecutorStatus_EXECUTOR_STATUS_PERMANENTLY_DRAINED ExecutorStatus = 4
)
...
var ExecutorStatus_name = map[int32]string{
	...
	4: "EXECUTOR_STATUS_PERMANENTLY_DRAINED",
}
...
var ExecutorStatus_value = map[string]int32{
	...
	"EXECUTOR_STATUS_PERMANENTLY_DRAINED": 4,
}
...
var fileDescriptor_5aab034437d08cca = []byte{
	...
	,
}
