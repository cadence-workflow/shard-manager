...
type HeartbeatRequest struct {
	...
	HostMetadata         *HostMetadata                 `protobuf:"bytes,7,opt,name=host_metadata,json=hostMetadata,proto3" json:"host_metadata,omitempty"`
...
func (m *HeartbeatRequest) GetHostId() string {
	if m != nil {
		return m.HostId
	}
	return ""
...
func (m *HeartbeatRequest) GetHostMetadata() *HostMetadata {
	if m != nil {
...
func (m *HostMetadata) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HostMetadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HostMetadata.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HostMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HostMetadata.Merge(m, src)
}
func (m *HostMetadata) XXX_Size() int {
	return m.Size()
}
func (m *HostMetadata) XXX_DiscardUnknown() {
	xxx_messageInfo_HostMetadata.DiscardUnknown(m)
}

var xxx_messageInfo_HostMetadata proto.InternalMessageInfo

func (m *HostMetadata) GetHostName() string {
	if m != nil {
		return m.HostName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*HostMetadata)(nil), "uber.cadence.sharddistributor.v1.HostMetadata")
...
var fileDescriptor_5aab034437d08cca = []byte{
	...
	,
}
...
func (m *HeartbeatRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HostId) > 0 {
		...
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.HostId)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Metadata) > 0 {
...
func (m *HostMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HostMetadata) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HostMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.HostName) > 0 {
		...
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.HostName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *HostMetadata) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HostMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
