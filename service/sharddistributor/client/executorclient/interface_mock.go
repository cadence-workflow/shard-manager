...
//
//	mockgen -package executorclient -source client.go -destination interface_mock.go . ShardProcessorFactory,ShardProcessor,Executor,Client,Debugger
//
...
// MockDebugger is a mock of Debugger interface.
type MockDebugger struct {
	ctrl     *gomock.Controller
	recorder *MockDebuggerMockRecorder
	isgomock struct{}
}

// MockDebuggerMockRecorder is the mock recorder for MockDebugger.
type MockDebuggerMockRecorder struct {
	mock *MockDebugger
}

// NewMockDebugger creates a new mock instance.
func NewMockDebugger(ctrl *gomock.Controller) *MockDebugger {
	mock := &MockDebugger{ctrl: ctrl}
	mock.recorder = &MockDebuggerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDebugger) EXPECT() *MockDebuggerMockRecorder {
	return m.recorder
}

// GetExecutorID mocks base method.
func (m *MockDebugger) GetExecutorID() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExecutorID")
	ret0, _ := ret[0].(string)
	return ret0
...
// GetExecutorID indicates an expected call of GetExecutorID.
func (mr *MockDebuggerMockRecorder) GetExecutorID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExecutorID", reflect.TypeOf((*MockDebugger)(nil).GetExecutorID))
}

// GetMetadata mocks base method.
func (m *MockDebugger) GetMetadata() map[string]string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMetadata")
	ret0, _ := ret[0].(map[string]string)
	return ret0
...
// GetMetadata indicates an expected call of GetMetadata.
func (mr *MockDebuggerMockRecorder) GetMetadata() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMetadata", reflect.TypeOf((*MockDebugger)(nil).GetMetadata))
}

// GetNamespace mocks base method.
func (m *MockDebugger) GetNamespace() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNamespace")
	ret0, _ := ret[0].(string)
	return ret0
...
// GetNamespace indicates an expected call of GetNamespace.
func (mr *MockDebuggerMockRecorder) GetNamespace() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNamespace", reflect.TypeOf((*MockDebugger)(nil).GetNamespace))
}

// GetShardStatusReports mocks base method.
func (m *MockDebugger) GetShardStatusReports() map[string]*types.ShardStatusReport {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetShardStatusReports")
	ret0, _ := ret[0].(map[string]*types.ShardStatusReport)
	return ret0
...
// GetShardStatusReports indicates an expected call of GetShardStatusReports.
func (mr *MockDebuggerMockRecorder) GetShardStatusReports() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetShardStatusReports", reflect.TypeOf((*MockDebugger)(nil).GetShardStatusReports))
}
