...
//
//	mockgen -package executorclient -source client.go -destination interface_mock.go . ShardProcessorFactory,ShardProcessor,Executor,Client,ExecutorInfo
//
...
func (m *MockExecutor[SP]) GetShardStatusReports() map[string]*types.ShardStatusReport {
	m.ctrl.T.Helper()
...
func (mr *MockExecutorMockRecorder[SP]) GetShardStatusReports() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetShardStatusReports", reflect.TypeOf((*MockExecutor[SP])(nil).GetShardStatusReports))
}
...
// MockExecutorInfo is a mock of ExecutorInfo interface.
type MockExecutorInfo struct {
	ctrl     *gomock.Controller
	recorder *MockExecutorInfoMockRecorder
	isgomock struct{}
}

// MockExecutorInfoMockRecorder is the mock recorder for MockExecutorInfo.
type MockExecutorInfoMockRecorder struct {
	mock *MockExecutorInfo
}

// NewMockExecutorInfo creates a new mock instance.
func NewMockExecutorInfo(ctrl *gomock.Controller) *MockExecutorInfo {
	mock := &MockExecutorInfo{ctrl: ctrl}
	mock.recorder = &MockExecutorInfoMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockExecutorInfo) EXPECT() *MockExecutorInfoMockRecorder {
	return m.recorder
}

// GetExecutorID mocks base method.
func (m *MockExecutorInfo) GetExecutorID() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExecutorID")
	ret0, _ := ret[0].(string)
	return ret0
...
// GetExecutorID indicates an expected call of GetExecutorID.
func (mr *MockExecutorInfoMockRecorder) GetExecutorID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExecutorID", reflect.TypeOf((*MockExecutorInfo)(nil).GetExecutorID))
}

// GetMetadata mocks base method.
func (m *MockExecutorInfo) GetMetadata() map[string]string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMetadata")
	ret0, _ := ret[0].(map[string]string)
	return ret0
...
// GetMetadata indicates an expected call of GetMetadata.
func (mr *MockExecutorInfoMockRecorder) GetMetadata() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMetadata", reflect.TypeOf((*MockExecutorInfo)(nil).GetMetadata))
}

// GetNamespace mocks base method.
func (m *MockExecutorInfo) GetNamespace() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNamespace")
	ret0, _ := ret[0].(string)
	return ret0
...
// GetNamespace indicates an expected call of GetNamespace.
func (mr *MockExecutorInfoMockRecorder) GetNamespace() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNamespace", reflect.TypeOf((*MockExecutorInfo)(nil).GetNamespace))
}

// GetShardStatusReports mocks base method.
func (m *MockExecutorInfo) GetShardStatusReports() map[string]*types.ShardStatusReport {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetShardStatusReports")
	ret0, _ := ret[0].(map[string]*types.ShardStatusReport)
	return ret0
...
// GetShardStatusReports indicates an expected call of GetShardStatusReports.
func (mr *MockExecutorInfoMockRecorder) GetShardStatusReports() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetShardStatusReports", reflect.TypeOf((*MockExecutorInfo)(nil).GetShardStatusReports))
}
