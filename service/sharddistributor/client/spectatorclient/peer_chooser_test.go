...
// Routing a drained shard must fail with a code callers do not retry. Reporting it as
// Unavailable would put the caller in a retry loop that can never succeed.
