...
func TestBuildHandoverStats(t *testing.T) {
	...
	testCases := []testCase{
		...
		{
			name:          "prev executor ACTIVE on drained host -> graceful handover",
			previousOwner: "host-a@uuid-1",
			drainedHosts: map[string]store.DrainedHost{
